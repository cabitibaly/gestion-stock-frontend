        ...
        <section className="relative px-6 pt-6 pb-2 w-full h-auto bg-noir flex items-start justify-start flex-col gap-8">
            ...
            <div className='mt-2 w-full flex items-end justify-between gap-4'>  
                <div className='flex items-end gap-6'>
                    <h1 className='text-5xl text-white font-bold tracking-wide'>Clients</h1>
                    <div className='border border-gray-300 h-7 px-2.5 py-0 rounded-lg flex items-center justify-center gap-2'>
                        <span className='text-white text-base font-semibold'>297</span>
                        <span className='text-gray-600 text-base font-semibold'>Clients</span>
                    </div>
                </div>  
                <form onSubmit={(e) => e.preventDefault()} className="w-[47%] flex items-center">   
                    ...
                    <div className="relative w-full flex items-center justify-center">
                        ...
                        <input value={recherche} onChange={(e) => setRecherche(e.target.value)} type="text" className="bg-transparent border-2 border-gray-600 text-gray-300 text-lg rounded-xl outline-none focus:ring-gray-300 focus:border-gray-300 block w-full ps-14  p-1.5 placeholder:text-gray-400" placeholder="Rechercher un client..." />
                    </div>
                </form> 
                ...
                <Link href={"/client/nouveau"} className='border border-transparent bg-vert px-2.5 py-2 cursor-pointer rounded-xl text-noir text-lg font-semibold transition duration-200 ease-in-out hover:bg-transparent hover:text-vert hover:border-vert'>
                    Nouveau Client
                </Link>                         
            </div>
            ...
            { isOpen && <ClientDetail id={1} setIsOpen={setIsOpen} isOpen={isOpen} /> }
        </section>        
    )
}
