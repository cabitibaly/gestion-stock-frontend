            ...
            <div className="w-full flex items-center justify-between">
                <div className="w-[40%] flex items-center">   
                    ...
                    <div className="relative w-full flex items-center justify-center">
                        ...
                        <input id="cat-search" type="text" className="bg-transparent border border-gray-600 text-gray-300 text-lg rounded-xl outline-none focus:ring-gray-300 focus:border-gray-300 block w-full ps-9  p-1.5 placeholder:text-gray-400" placeholder="Recherche..." />
                    </div>
                </div>
