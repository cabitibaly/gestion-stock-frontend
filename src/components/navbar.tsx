    ...
    return (
        <nav className="w-full flex items-center justify-between">
            ...
            <ul className="flex items-center justify-between gap-8">
                ...
                <li className={`rounded-full group transition-all duration-200 ease-in-out hover:bg-fonce-200 hover:border-transparent ${pathname === "/vente" ? "bg-fonce-200" : "border border-gray-600" }`}>
