    ...
    return (
        <nav className="w-full flex items-center justify-between">
            ...
            <ul className="flex items-center justify-between gap-8">
                <li className={`rounded-full group transition-all duration-200 ease-in-out hover:bg-fonce-200 hover:border-none ${pathname === "/" ? "bg-fonce-200" : "border border-gray-600" }`}>
                ...
                <li className={`rounded-full group transition-all duration-200 ease-in-out hover:bg-fonce-200 hover:border-none ${pathname === "/inventaire" ? "bg-fonce-200" : "border border-gray-600" }`}>
                ...
                <li className={`rounded-full group transition-all duration-200 ease-in-out hover:bg-fonce-200 hover:border-none ${pathname === "/vente" ? "bg-fonce-200" : "border border-gray-600" }`}>
                ...
                <li className={`rounded-full group transition-all duration-200 ease-in-out hover:bg-fonce-200 hover:border-none ${pathname === "/bon-commande" ? "bg-fonce-200" : "border border-gray-600" }`}>
                ...
                <li className={`rounded-full group transition-all duration-200 ease-in-out hover:bg-fonce-200 hover:border-none ${pathname === "/factures" ? "bg-fonce-200" : "border border-gray-600" }`}>
                    <Link href={"/vente"} className="py-2 px-4 flex items-center justify-center gap-2">
